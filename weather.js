...
// let location= "austin";
jqueryUrl= "http://api.openweathermap.org/data/2.5/weather?q="+location+"&units=imperial&"+key;   
}
let m= moment();
...
function getWeather(){
    ...
    lati();
        ...
        $.ajax({
            type:"GET",
            url:"http://api.openweathermap.org/data/2.5/onecall?lat="+lat1+"&lon="+long1+"&exclude=hourly,minutely&units=imperial&appid=04a7544cde188fba131a9fa347638501"
